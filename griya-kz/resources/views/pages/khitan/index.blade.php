                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div>
                            ...
                            <a href="{{route('tambah_khitan')}}"><button type="button" class="btn btn-primary mb-4" style="margin-bottom: 1rem;"><i class="mdi mdi-plus me-1"></i>Tambah
                                    Khitan</button></a>
                        </div>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <a class="btn btn-primary shadow btn-xs sharp me-1" title="Edit" href="{{ route('edit_khitan', ['id' => $khitans->id]) }}"><i class="fa fa-pencil-alt"></i></a>
                                                <form action="{{ route('delete', $khitans->id) }}" method="POST" id="delete-form-{{ $khitans->id }}" class="d-inline">
                                                    @csrf
                                                    <button type="submit" class="btn btn-danger shadow btn-xs sharp me-1" data-id="{{ $khitans->id }}"><i class="bi bi-trash"></i></button>
                                                </form>
                                            </div>
                                        </td>
                                    </tr>
